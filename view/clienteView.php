    ...
    <head>
        ...
        function confirmarRemover(id) {
                if (id == 'sinValor') {
                    ...
                    ventana = confirm("¿Esta seguro que desea eliminar el cliente seleccionado?");
                    if (ventana) {
                        window.location.href = "<?php echo $helper->url("clientes", "borrar"); ?>&id=" + id;
                    }
                }
        }
            function confirmarEditar(id) {
                if (id == 'sinValor') {
                    ...
                    ventana = confirm("¿Esta seguro que desea actualizar el cliente seleccionado?");
                    if (ventana) {
                        window.location.href = "<?php echo $helper->url("clientes", "update"); ?>&id=" + id;
                    }
                }
            }
...
{	
    ...
    <body style="background-color:#9E9E9E;" >
        ...
        ?>
             <form action="<?php echo $helper->url("clientes", "buscarNombreCliente"); ?>" method="post">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form role="form" name="form1" method="post" action="<?php echo $helper->url("clientes", "crear");?>" onSubmit="javascript:return Rut(document.form1.rutUsuario.value)">
                                            ...
                                            <div class="form-group"><label>Nombre Completo: </label><input type="text" class="form-control" name="nombreCliente" required=""/></div>
                                            <div class="form-group"><label>Dirección: </label><input type="text" class="form-control" name="direccionCliente" required=""/></div>
                                            <div class="form-group"><label>Telefono: </label><input type="number" min="200000000" max="999999999" class="form-control" name="telefonoCliente" required=""/></div>
                                            <div class="form-group"><label >Fecha de incorporación:</label><p><input min="2016-01-01" max="2018-12-31" value="<?php echo date('Y-m-d');?>" type="date" class="form-control" name="fechaCliente"/></p> </div>
